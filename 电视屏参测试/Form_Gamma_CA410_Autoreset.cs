...
{
    public partial class Form_Gamma_CA410_Autoreset : Form
    {
        public Form_Gamma_CA410_Autoreset()
        {
            InitializeComponent();
        ...
        System.Timers.Timer timer_read_result, timer_test_timeout, timer_check_move_finished, timer_delay;
        ...
        private void serialPort_CA410_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                Invoke(new EventHandler(delegate
                {
                    ...
                    //OK00,P1,0,0.3776743,0.2927169,1.7717249,-0.03,-99999999 56个字符，结尾有一个0x0D换行符
        ...
        AutoResetEvent ca410_prepare_event;


        private void btn_start_Click(object sender, EventArgs e)
        {
            ca410_prepare_event = new AutoResetEvent(false);
            if (ca410_ready == false) {
                addmemo_txt("CA410准备中");
            ...
            Thread test = new Thread(new ThreadStart(Test_Main));
            test.Start();
        ...
        private void btn_ca410_portsave_Click(object sender, EventArgs e)
        {
            config_json.save("CA410_SerialPort_PortName", cmbPortName.Text);
        }
